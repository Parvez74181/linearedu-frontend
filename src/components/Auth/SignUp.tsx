...
export default function SignUp() {
  ...
  const handleSubmitButtonClick = async () => {
    if (!phoneNumber) {
      showToast("Error", "danger", "Phone Number is Required");
      setLoading(false);
      return;
    }
    ...
    //   showToast("Error", "danger", "Name, PhoneNumber, Password everything is required");
    //   setLoading(false);
    //   return;
    // }
        ...
        <Card className="p-5 bg-dark-1">
          ...
          <CardBody>
            ...
            <Button
              ...
              onPress={otpVerify}
            >
              {loading ? <Loader2 size={16} className="animate-spin" /> : <p> OTP Verify </p>}
            </Button>
